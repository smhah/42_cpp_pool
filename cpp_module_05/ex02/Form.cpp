...
Form::Form(std::string const name,std::string target, int const gradeSign, int const gradeExecute) : _name(name) ,_target(target) , _gradeSign(gradeSign), _gradeExectute(gradeExecute)
{
